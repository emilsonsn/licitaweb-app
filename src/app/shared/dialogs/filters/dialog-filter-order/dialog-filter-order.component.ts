...
@Component({
  selector: 'app-dialog-filter-order',
  templateUrl: './dialog-filter-order.component.html',
  styleUrl: './dialog-filter-order.component.scss'
})
export class DialogFilterOrderComponent {
  ...
  constructor(
    ...
    private readonly dialogRef: MatDialogRef<DialogFilterOrderComponent>,
